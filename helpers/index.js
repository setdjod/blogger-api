...
module.exports = {
  ...
  getEntry: function(entry, json) {
    ...
    var data = {
      ...
      updated: this.getTimes(entry.updated, "id", "LLL"),
      published: this.getTimesAgo(entry.published, "id"),
  ...
  getEntries: function(entry) {
    ...
    for (var i = 0; i < entry.length; i++) {
      data.push({
        ...
        updated: this.getTimesAgo(entry[i].updated, "id"),
        published: this.getTimesAgo(entry[i].published, "id")
      });
    }
    return data;
  },
